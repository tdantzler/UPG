...
FORMAT REQUIREMENTS — return ONLY raw HTML (no markdown, no backticks, no explanation). CRITICAL: Use INLINE STYLES on every element. Do NOT use CSS classes — email clients strip them.

1. Open with: <h1 style="font-family:Segoe UI,Arial,sans-serif;font-weight:800;font-size:26px;color:#3a3a3c;margin-bottom:4px;">AI & Automation Roadmap — <span style="color:#f1592a;">UPG Insurance</span></h1> followed by <p style="font-size:12px;color:#6b6b6e;margin-bottom:24px;padding-bottom:16px;border-bottom:2px solid #e2e2e4;">Custom workup generated by Knowlogix AI — [today's date]</p>

2. Brief "What We Heard" summary — 3-4 sentences. Use <h2 style="font-family:Segoe UI,Arial,sans-serif;font-weight:700;font-size:16px;color:#f1592a;margin-top:24px;margin-bottom:8px;padding-bottom:4px;border-bottom:1px solid #fef0eb;">

3. FOR EACH CHECKED ATTENDEE: Wrap in <div style="background:#f8f8f9;border:1px solid #e2e2e4;border-radius:8px;padding:14px 18px;margin-bottom:12px;">. Name: <div style="font-family:Segoe UI,Arial,sans-serif;font-weight:700;font-size:14px;color:#3a3a3c;">. Role: <div style="font-size:11px;color:#a0a0a3;margin-bottom:8px;">. Each opportunity: <div style="padding-left:12px;border-left:3px solid #f1592a;margin-bottom:8px;">
...
4. Recommended Next Steps section with the same h2 styling.

5. CTA block: <div style="background:#f1592a;color:#fff;border-radius:8px;padding:18px 22px;margin-top:24px;"><h3 style="color:#fff;margin-top:0;font-size:15px;">Knowlogix</h3><p style="color:rgba(255,255,255,0.9);margin-bottom:4px;">843-900-4576 | knowlogix.com | info@knowlogix.com</p></div>

All paragraph text should use: style="font-family:Segoe UI,Arial,sans-serif;font-size:13px;color:#3a3a3c;line-height:1.65;margin-bottom:8px;"
...
Generate the HTML brochure now. Return ONLY the inner HTML content — no doctype, html, head, or body tags. Use INLINE STYLES on every element as specified above. Do NOT use CSS classes.`;
